...
const Enter: NextPage = () => {
  ...
  return (
    <Layout>
      <div className="mt-5 px-4 bg-gray-100">
        <div className="flex flex-col lg:flex-row w-full justify-center gap-4 items-center">
          <div className="w-full max-w-[30rem]">
            <h3 className="text-3xl font-bold text-center">Welcome to Sunny&apos;s&nbsp;Express</h3>
            <div className="mt-12">
              {data?.ok ?
          ...
          <div className="bg-red-300 w-full max-w-[30rem] p-2 flex flex-col">
            <span className="text-2xl font-bold">Don&apos;t have an account?</span>
            <span>Please Sign up with either Email or Phone number</span>
          </div>
        </div>
      </div>
    </Layout>
