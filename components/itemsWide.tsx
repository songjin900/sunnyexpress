        ...
        <Link legacyBehavior href={`/items/${id}`}>
            ...
            <div className="p-2 cursor-pointer border-y-8 border-gray-100 bg-white">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col pl-2 mt-2 bg-red-100 w-full">
                ...
                <div className="flex justify-between mt-4 flex-row  md:gap-x-4">
                    <div className="flex items-center gap-x-2 bg-purple-400">
